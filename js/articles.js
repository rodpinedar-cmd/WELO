// WELO — Biblioteca Articles Database
const A={
'ciclo-1':{t:'Fases del ciclo menstrual: guía completa',b:`
...
<p><strong>Cómo te sientes:</strong> Fatiga, posibles cólicos, necesidad de introspección. Es tu "invierno interior" — un momento para bajar el ritmo sin culpa.</p>
<p><strong>Qué hacer:</strong> Yoga restaurativo, caminatas suaves, infusiones de jengibre, bolsa de calor. Dormir más. En pareja: pedir espacio sin que sea personal.</p>
<p><strong>Nutrición:</strong> Hierro (espinacas, lentejas, carne roja), magnesio (chocolate 70%), omega-3 (salmón, nueces).</p>

<h2>2. Fase Folicular (días 6-13)</h2>
<p>Los estrógenos empiezan a subir progresivamente. Tu cuerpo prepara un óvulo para la ovulación. La energía aumenta cada día.</p>
<p><strong>Cómo te sientes:</strong> Optimista, creativa, con ganas de socializar y emprender cosas nuevas. Es tu "primavera" — aprovecha para proyectos, citas y deporte.</p>
<p><strong>Qué hacer:</strong> HIIT, pesas, cardio intenso. Iniciar proyectos. Proponer planes de pareja. Tu piel se ve mejor naturalmente.</p>
<p><strong>Nutrición:</strong> Proteína ligera, fermentados (kimchi, yogur), vegetales frescos y crujientes.</p>

<h2>3. Ovulación (días 14-16)</h2>
<p>Pico de estrógenos + aumento de testosterona. El óvulo se libera. Fertilidad máxima durante 12-24 horas.</p>
<p><strong>Cómo te sientes:</strong> En tu mejor momento. Confianza, atracción, sociabilidad, libido alta. Es tu "verano" — el momento de brillar.</p>
<p><strong>Qué hacer:</strong> Citas, presentaciones, fotos, deporte social (bachata, vóley), networking. Tu coordinación y reflejos están al máximo.</p>
<p><strong>Señales:</strong> Moco cervical transparente y elástico, temperatura basal sube 0.3°C después, posible dolor en un costado (mittelschmerz).</p>

<h2>4. Fase Lútea (días 17-28)</h2>
<p>La progesterona domina. Si no hay embarazo, todo empieza a bajar gradualmente. La serotonina disminuye.</p>
<p><strong>Cómo te sientes:</strong> Primera mitad: aún bien. Segunda mitad: irritabilidad, antojos, hinchazón, acné. Es tu "otoño" — baja intensidad gradual.</p>
<p><strong>Qué hacer:</strong> Pilates, natación, yoga flow. Journaling. Autocuidado sin culpa. Carbos complejos para la serotonina.</p>
<p><strong>Para él:</strong> No lo tomes personal. No intentes "arreglar". Espacio + cariño. Chocolate y paciencia.</p>

<h2>Dato clave</h2>
<p>Cada mujer tiene un ciclo diferente (21-35 días es normal). Trackear durante 3 meses te da suficiente data para predecir tus patrones con precisión.</p>
`},
'ciclo-2':{t:'Ovulación: señales para identificarla',b:`
<h2>¿Cómo saber cuándo ovulas?</h2>
...
<p><strong>4. Libido aumentada:</strong> Tu cuerpo QUIERE reproducirse en este momento. Es biológico y completamente normal que te sientas más atraída.</p>
<p><strong>5. Piel luminosa:</strong> Los estrógenos en su pico mejoran la hidratación y luminosidad. Es tu mejor momento para fotos y citas.</p>
<p><strong>6. Sensibilidad en pechos:</strong> Leve sensibilidad o hinchazón después de ovular, causada por la progesterona que empieza a subir.</p>

<h2>¿Por qué importa saber cuándo ovulas?</h2>
<ul>
<li>Predecir tu periodo con más precisión (siempre viene ~14 días después)</li>
<li>Entender cambios de humor y energía</li>
<li>Planificar o evitar embarazo de forma natural</li>
<li>Programar actividades según tu pico de energía</li>
<li>Aprovechar tu mejor momento para citas, deporte y trabajo creativo</li>
</ul>
`},
'ciclo-3':{t:'¿Por qué se retrasa mi periodo? 10 causas',b:`
<h2>¿Es normal que se retrase?</h2>
...
<p><strong>4. Viajes y jet lag:</strong> Tu reloj biológico controla las hormonas. Cambiar de zona horaria, horarios de sueño o rutina puede confundirlo temporalmente.</p>
<p><strong>5. Anticonceptivos:</strong> Al dejar la píldora, tu cuerpo necesita 1-3 meses (a veces hasta 6) para recalibrar su producción hormonal natural.</p>
<p><strong>6. SOP (Síndrome de Ovarios Poliquísticos):</strong> Afecta al 10-15% de mujeres. Causa ciclos irregulares, acné y exceso de andrógenos. Requiere diagnóstico médico.</p>
<p><strong>7. Tiroides:</strong> Tanto el hipotiroidismo como el hipertiroidismo alteran el ciclo menstrual. Un análisis de sangre simple lo detecta.</p>
<p><strong>8. Lactancia:</strong> La prolactina (hormona de la leche) suprime la ovulación. Es normal no menstruar durante meses mientras amamantas.</p>
<p><strong>9. Edad:</strong> A partir de los 40-45, la perimenopausia trae irregularidades. Los ciclos se acortan o alargan antes de desaparecer.</p>
<p><strong>10. Enfermedad:</strong> Gripe, COVID, infecciones — tu cuerpo prioriza recuperarse y puede "pausar" la ovulación temporalmente.</p>

<h2>¿Cuándo consultar al médico?</h2>
<ul>
<li>Más de 3 meses sin periodo (sin embarazo ni lactancia)</li>
<li>Sangrado muy abundante o con coágulos grandes</li>
<li>Dolor severo que no mejora con ibuprofeno</li>
<li>Ciclos menores de 21 días o mayores de 40 consistentemente</li>
</ul>
`},
'ciclo-4':{t:'Cólicos menstruales: 8 remedios naturales que funcionan',b:`
<h2>Por qué duelen los cólicos</h2>
...
<p><strong>4. Omega-3:</strong> Reduce la producción de prostaglandinas inflamatorias. Salmón, sardinas, nueces, semillas de chía o lino. O suplemento: 1000mg EPA+DHA.</p>
<p><strong>5. Ejercicio suave:</strong> Caminar 30 min o hacer yoga libera endorfinas — analgésicos naturales. No necesitas HIIT, basta con moverte. La postura del niño (Balasana) es especialmente buena.</p>
<p><strong>6. Orgasmo:</strong> Libera oxitocina que relaja el útero y alivia cólicos hasta 4 horas. Es ciencia real, no mito. Funciona solo o en pareja.</p>
<p><strong>7. Infusión de manzanilla:</strong> Antiinflamatoria y relajante muscular. 2-3 tazas al día durante el periodo. Añadir miel si necesitas energía.</p>
<p><strong>8. Chocolate oscuro 70%+:</strong> Rico en magnesio (64mg por 30g). Tu antojo tiene base científica — tu cuerpo está pidiendo magnesio. No es debilidad, es inteligencia corporal.</p>

<h2>Cuándo es más que "cólicos normales"</h2>
<p>Si el dolor no mejora con ibuprofeno + calor, si te impide ir a trabajar/estudiar, o si ha empeorado con el tiempo — consulta. Podría ser endometriosis (afecta al 10% de mujeres) o adenomiosis.</p>
`},
...
<p>Síntomas SEVEROS: depresión intensa, ansiedad incapacitante, ira desproporcionada, pensamientos de desesperanza, incapacidad de funcionar normalmente. Aparece 7-10 días antes y desaparece completamente con el periodo.</p>
<p><strong>La clave:</strong> Si tus síntomas interfieren seriamente con trabajo, relaciones y vida diaria SOLO en la fase lútea → puede ser PMDD.</p>
<h2>Qué hacer</h2>
<p>Lleva un diario de síntomas 2-3 ciclos. Si ves un patrón claro (severo en lútea, bien después del periodo), consulta ginecóloga. Tratamientos efectivos incluyen SSRIs (solo en fase lútea), calcio 1200mg, y terapia cognitivo-conductual.</p>
`},
'ciclo-6':{t:'Anticoncepción y ciclo: cómo te afectan',b:`
...
<p><strong>Implante subdérmico:</strong> Suprime ovulación. Sangrado irregular es muy común (manchado impredecible). Dura 3 años.</p>
<h2>Después de dejar anticonceptivos</h2>
<p>Tu cuerpo necesita recalibrarse. Es normal: 2-6 meses de irregularidad, posible acné (rebote hormonal), cambios de humor, y aumento temporal de libido. El cycle syncing y tracking de WELO empieza a ser útil cuando tu ciclo se regula naturalmente.</p>
`},
'sexo-1':{t:'Libido y ciclo: tu deseo tiene un patrón',b:`
...
<p><strong>Lútea temprana (días 17-21):</strong> Aún relativamente alto por la progesterona inicial.</p>
<p><strong>Lútea tardía (días 22-28):</strong> Baja. Serotonina baja, todo baja. Hinchazón, irritabilidad. Es biología, no falta de amor.</p>
<h2>Lo que él necesita entender</h2>
<p>Los "no" en fase lútea tardía NO son rechazo personal. Son biología pura. Lo mejor que puede hacer: ofrecer cariño físico sin expectativa sexual — abrazos, caricias, masajes. Eso construye intimidad y confianza para cuando el deseo vuelva naturalmente.</p>
`},
...
<p><strong>4. Alivia cólicos:</strong> Las contracciones del orgasmo ayudan al útero a liberar la sangre menstrual. La oxitocina relaja los músculos uterinos hasta 4 horas.</p>
<p><strong>5. Quema calorías:</strong> Entre 85-150 calorías por sesión de 30 min. No reemplaza el gym, pero suma.</p>
<p><strong>6. Fortalece el sistema inmune:</strong> Personas que tienen sexo 1-2x/semana tienen 30% más inmunoglobulina A (anticuerpos).</p>
<p><strong>7. Reduce dolor de cabeza:</strong> Contradice el cliché — el orgasmo libera endorfinas que alivian migrañas en el 60% de casos.</p>
<p><strong>8. Mejora autoestima:</strong> La intimidad y sentirse deseada/o mejora la percepción de uno mismo.</p>
<p><strong>9. Baja presión arterial:</strong> Las relaciones sexuales regulares se asocian con presión arterial más baja.</p>
<p><strong>10. Fortalece piso pélvico:</strong> Las contracciones del orgasmo son ejercicios de Kegel naturales.</p>
`},
'sexo-3':{t:'Ardor durante las relaciones: causas y qué hacer',b:`
...
<p><strong>Vaginismo:</strong> Contracción involuntaria de los músculos vaginales. Tiene componente psicológico. Fisioterapia de suelo pélvico ayuda mucho.</p>
<p><strong>Endometriosis:</strong> Dolor profundo durante la penetración, especialmente en ciertas posiciones. Afecta al 10% de mujeres. Consulta ginecóloga.</p>
<h2>Qué hacer</h2>
<p>1) Comunica a tu pareja sin vergüenza. 2) Usa lubricante siempre (no es fracaso, es comodidad). 3) Más preliminares (mínimo 15-20 min). 4) Experimenta posiciones diferentes. 5) Si persiste → ginecóloga.</p>
`},
...
<p><strong>3. Contacto diario fuera del dormitorio:</strong> Besos al llegar, mano en la espalda, abrazos random. El deseo se cocina durante el día.</p>
<p><strong>4. Explorar sin presión de orgasmo:</strong> Cuando quitas la "meta", paradójicamente llegas más fácil. Disfruta el proceso.</p>
<p><strong>5. Hablar de fantasías con respeto:</strong> Sin juzgar. No tienes que cumplirlas todas — pero compartirlas crea intimidad.</p>
<p><strong>6. Celulares FUERA del dormitorio:</strong> La pantalla antes de dormir mata la espontaneidad. Punto.</p>
<p><strong>7. Probar algo nuevo cada mes:</strong> No necesita ser extremo. Una posición nueva, un lugar diferente, un juego.</p>
<p><strong>8. Atención al lenguaje corporal:</strong> Aprende a leer a tu pareja. Suspiros, movimientos, ritmo. Es comunicación no verbal.</p>
<p><strong>9. No comparar con pornografía:</strong> La pornografía no es educación sexual. El sexo real es más lento, más torpe y más íntimo.</p>
<p><strong>10. Intimidad emocional primero:</strong> Las parejas que hablan de sus miedos y sueños tienen mejor sexo. La vulnerabilidad conecta.</p>
<p><strong>11. Agradecer después:</strong> Un "eso fue increíble" o un abrazo prolongado post-sexo refuerza el vínculo.</p>
<p><strong>12. Nunca por obligación:</strong> El sexo por compromiso erosiona el deseo a largo plazo. Mejor menos frecuencia con más ganas.</p>
`},
'sexo-5':{t:'Deseo sexual bajo: 5 razones y soluciones',b:`
...
<p><strong>4. Rutina de pareja:</strong> Después de años, la novedad desaparece. El deseo espontáneo se reemplaza por deseo receptivo — no es menos válido, pero necesitas crear el contexto.</p>
<p><strong>5. Desconexión emocional:</strong> Conflictos no resueltos, resentimiento acumulado, falta de conversaciones profundas. Es imposible desear a alguien con quien estás enfadada.</p>
<h2>Qué hacer</h2>
<p>Identifica cuál es TU causa principal. Habla con tu pareja sin culpa ("no es sobre ti, es sobre lo que está pasando"). Prioriza intimidad no sexual como puente (caricias, besos, masajes). Si es médico → consulta profesional.</p>
`},
'sexo-6':{t:'Sexo y ciclo: la mejor guía por fase',b:`
<h2>Adapta la intimidad a tu biología</h2>
<p><strong>Menstrual:</strong> Si ambos quieren, adelante — no hay contraindicación médica. Toalla oscura, ducha antes/después. El orgasmo alivia cólicos genuinamente. Posiciones con menos penetración profunda si hay sensibilidad.</p>
<p><strong>Folicular:</strong> La energía y lubricación suben. Buen momento para explorar cosas nuevas, ser más activa, probar posiciones que requieren más esfuerzo.</p>
<p><strong>Ovulación:</strong> Máximo deseo natural. Sensibilidad aumentada. Orgasmos más intensos y fáciles de alcanzar. Tu cuerpo está literalmente diseñado para el sexo en este momento.</p>
<p><strong>Lútea:</strong> Baja gradual. Más sensibilidad emocional. Prioriza caricias, masajes, intimidad sin presión. El contacto piel con piel libera oxitocina sin necesidad de llegar al sexo.</p>
`},
'sexo-7':{t:'Métodos anticonceptivos: todo lo que necesitas saber',b:`
<h2>Opciones disponibles</h2>
<p><strong>Hormonales combinados (estrógeno + progesterona):</strong> Píldora (99.7% con uso perfecto), parche semanal, anillo vaginal mensual. Suprimen ovulación.</p>
<p><strong>Solo progesterona:</strong> Mini-píldora, implante (99.9%, 3 años), inyección trimestral. Opciones si no toleras estrógenos.</p>
<p><strong>DIU:</strong> Hormonal (Mirena/Kyleena): 99.8%, dura 5 años, reduce sangrado. Cobre (Paragard): 99.4%, sin hormonas, dura 10 años, puede aumentar sangrado.</p>
<p><strong>Barrera:</strong> Condón masculino (98% uso perfecto, 87% uso real), condón femenino, diafragma. Únicos que protegen contra ITS.</p>
<p><strong>Naturales:</strong> Método sintotérmico (temperatura + moco + cálculo): 95-99% si se hace bien. Requiere disciplina y formación. Apps como WELO ayudan a trackear.</p>
<p><strong>Emergencia:</strong> Píldora del día después (hasta 72h, idealmente primeras 12h). NO es método anticonceptivo regular.</p>
<p>Ningún método es perfecto para todas. Consulta con tu ginecóloga considerando: efectos secundarios, comodidad, planes de fertilidad futura, y preferencias personales.</p>
`},
'sexo-8':{t:'Dejar la píldora: timeline y qué esperar',b:`
<h2>Tu cuerpo necesita tiempo para recalibrarse</h2>
<p><strong>Semana 1-2:</strong> Posible sangrado por deprivación (no es periodo real). Tu cuerpo nota la ausencia de hormonas sintéticas.</p>
<p><strong>Mes 1-3:</strong> Ciclo irregular. Posible acné (rebote androgénico). Cambios de humor mientras las hormonas naturales se recalibran. Pueden volver cólicos que la píldora suprimía.</p>
<p><strong>Mes 3-6:</strong> La mayoría regularizan ciclo. Ovulación detectable con tracking de temperatura y moco.</p>
<p><strong>Cambios positivos:</strong> Muchas reportan aumento de libido, mejor lubricación, más conexión con su cuerpo, y emociones más "reales" (menos aplanadas).</p>
<p><strong>Tip:</strong> Empieza a trackear tu ciclo desde el día que dejas la píldora. WELO te ayuda a identificar cuándo vuelve la ovulación natural y tus patrones propios.</p>
`},
'pareja-1':{t:'Los 5 Lenguajes del Amor: descubre el tuyo',b:`
...
<p><strong>4. Tiempo de Calidad:</strong> Atención PLENA. Sin celular, sin tele de fondo. Presencia total. 15 minutos de atención real > 3 horas juntos pero distraídos.</p>
<p><strong>5. Contacto Físico:</strong> Abrazos, caricias, tomarse de la mano, cercanía corporal. Sin esto, se sienten invisibles aunque les digas "te amo" mil veces.</p>
<h2>Cómo descubrirlo</h2>
<p>Pregúntate: ¿Qué me DUELE más cuando falta? ¿Qué me hace sentir más amada/o? Eso es tu lenguaje principal.</p>
<p><strong>El reto:</strong> Practica el lenguaje de tu PAREJA (no el tuyo) durante 7 días. Observa cómo cambia la dinámica. Es como magia.</p>
`},
...
<h2>2. Desprecio</h2>
<p>Sarcasmo, ojos en blanco, burla, superioridad moral. Es el MÁS destructivo de los 4. El desprecio comunica "eres inferior a mí". El antídoto: cultivar genuinamente admiración y gratitud por tu pareja. Buscar lo bueno activamente.</p>
<h2>3. Defensividad</h2>
<p>"Yo no hice nada" / "¡Pero tú también..." Negar responsabilidad o contraatacar escala el conflicto SIEMPRE. El antídoto: asumir aunque sea responsabilidad parcial. "Tienes razón en que podría haber..." desarma instantáneamente.</p>
<h2>4. Evasión (Stonewalling)</h2>
<p>Desconectarse emocionalmente. Cerrarse. Dejar de escuchar. Poner un muro. Generalmente aparece cuando los otros 3 ya saturaron. El antídoto: pedir una pausa de 20 min ("necesito calmarme, vuelvo en 20 min") en vez de desaparecer.</p>
<h2>La regla de oro: 5:1</h2>
<p>Las parejas felices tienen 5 interacciones positivas por cada 1 negativa. Las que se divorcian están en 0.8:1. Construye "balance positivo" diario.</p>
`},
'pareja-3':{t:'Cómo resolver conflictos sin destruir la relación',b:`
...
<p><strong>4. Nunca "siempre" ni "nunca":</strong> Generalizaciones absolutas invalidan a tu pareja. "A veces siento que..." es más preciso y menos agresivo.</p>
<p><strong>5. Atacar el problema, no a la persona:</strong> Ustedes dos vs. el problema. No tú vs. yo.</p>
<p><strong>6. Pausa de 20 minutos:</strong> Si uno se cierra o la conversación escala: PAUSA. "Necesito 20 min para calmarme. Vuelvo." Tu ritmo cardíaco necesita bajar de 100bpm para pensar con claridad.</p>
<p><strong>7. Volver al tema:</strong> Después de la pausa, VOLVER. No pretender que no pasó nada. "¿Podemos retomarlo? Ya estoy más tranquilo/a."</p>
`},
'pareja-4':{t:'Estilos de apego: por qué amas como amas',b:`
...
<h2>La trampa ansioso-evitante</h2>
<p>Es la combinación MÁS común y problemática: el ansioso persigue → el evitante huye → el ansioso persigue más → el evitante huye más. Ciclo infinito hasta que uno se agota.</p>
<h2>Cómo moverse hacia seguro</h2>
<p><strong>Si eres ansioso:</strong> Practica autovalidación. Tolera distancia sin interpretar como rechazo. Pregunta en vez de asumir. Cultiva vida propia.</p>
<p><strong>Si eres evitante:</strong> Practica vulnerabilidad en dosis pequeñas. Tolera cercanía sin huir. Comunica cuando necesitas espacio (en vez de desaparecer).</p>
`},
...
<p>Los conflictos son inevitables y hasta saludables. La clave es tener suficiente "saldo positivo" en la cuenta para que los retiros (conflictos) no la dejen en rojo.</p>
<p><strong>Práctica WELO:</strong> El sistema de reconocimiento ("me sentí escuchada") es exactamente esto — depositar interacciones positivas en la cuenta de la relación.</p>
`},
'pareja-6':{t:'Dependencia emocional: señales y cómo trabajarla',b:`
...
<p><strong>2. Cultivar vida propia:</strong> Retoma hobbies, amigos, metas personales que abandonaste.</p>
<p><strong>3. Tolerar la incomodidad:</strong> Practica estar sola/o sin buscar inmediatamente distracción o contacto.</p>
<p><strong>4. Autovalidación:</strong> "Estoy bien sin su aprobación" — repítelo hasta internalizarlo. Es un músculo que se entrena.</p>
`},
...
<p><strong>Lútea:</strong> Producción de sebo aumenta por progesterona. Granos pueden aparecer (mandíbula/mentón = hormonal). Rutina: limpieza doble nocturna + niacinamida 5% + zinc tópico. No tocar los granos.</p>
`},
'belleza-2':{t:'Acné hormonal: identificarlo y tratarlo',b:`
<h2>No es tu higiene — son tus hormonas</h2>
<p>El acné hormonal aparece en mandíbula, mentón y mejillas inferiores. Es quístico (profundo, doloroso) y aparece predeciblemente en la fase lútea. La progesterona estimula las glándulas sebáceas.</p>
<h2>Tratamiento que funciona</h2>
<p><strong>Tópico:</strong> Niacinamida 5% (regula sebo), zinc tópico, retinol 0.3% (empezar suave, 2x/semana). Ácido azelaico 15-20% para manchas post-acné.</p>
<p><strong>Oral:</strong> Zinc 30mg/día, omega-3 (antiinflamatorio). Reducir lácteos si notas correlación (no todas responden igual).</p>
<p><strong>Hábitos:</strong> NO tocar/explotar (empeora y deja marcas). Cambiar funda de almohada 2x/semana. Limpiar celular.</p>
<p><strong>Cuándo consultar:</strong> Si es severo, doloroso o deja cicatrices → dermatóloga. Opciones médicas: isotretinoína, espironolactona, o ciertos anticonceptivos.</p>
`},
'belleza-3':{t:'Retención de líquidos: por qué y cómo reducirla',b:`
<h2>Normal antes del periodo — hay formas de manejarlo</h2>
<p>La progesterona en fase lútea causa que tu cuerpo retenga más agua y sodio. Es normal ganar 1-3kg de agua antes del periodo (se pierde al menstruar). No es grasa real.</p>
<h2>Cómo reducirla</h2>
<p><strong>1. Reducir sal:</strong> 7 días antes del periodo, baja la sal añadida. Lee etiquetas — los alimentos procesados tienen mucha.</p>
<p><strong>2. Beber MÁS agua:</strong> Paradójicamente, deshidratarte hace que tu cuerpo retenga más. 2-2.5L/día.</p>
<p><strong>3. Potasio:</strong> Equilibra el sodio. Plátano, aguacate, espinacas, patata.</p>
<p><strong>4. Movimiento suave:</strong> Caminata, yoga, nadar. Activa circulación linfática.</p>
<p><strong>5. Infusiones diuréticas:</strong> Diente de león, cola de caballo, té verde. No exceder 2-3 tazas.</p>
<p><strong>6. Elevar piernas:</strong> 15 min al día con piernas por encima del corazón reduce hinchazón.</p>
`},
...
<p><strong>Ovulación (días 14-16):</strong> Peak performance. Coordinación y reflejos al máximo. Ideal para PRs, competiciones, deporte social (bachata, vóley, pádel). Cuidado: también hay más riesgo de lesión de ligamentos (laxitud por estrógenos).</p>
<p><strong>Lútea (días 17-28):</strong> Baja intensidad gradual. Pilates, natación, yoga flow. Tu coordinación disminuye. Tu metabolismo está +200-300cal más alto: COME MÁS sin culpa. Tu cuerpo lo necesita.</p>
`},
...
<p><strong>Intermedios:</strong> Running juntos (sin competir), escalada indoor (confianza absoluta), paddle surf, clases de baile.</p>
<p><strong>Avanzados:</strong> CrossFit, senderismo de montaña, artes marciales, entrenamiento funcional en pareja.</p>
<h2>Regla de oro</h2>
<p>NO compitan entre ustedes. El objetivo es disfrutar juntos, no demostrar quién es mejor. Celebra sus logros como si fueran tuyos.</p>
`},
...
<p><strong>4. Apanasana (Rodillas al pecho):</strong> Boca arriba, abraza rodillas al pecho. Masajea intestinos y zona lumbar. Balancear suavemente a los lados. 1-2 min.</p>
<p><strong>5. Savasana con calor:</strong> Boca arriba, bolsa caliente en el vientre bajo, ojos cerrados. Respiración profunda. 5 min mínimo.</p>
<p><strong>Tip:</strong> Respira LENTO en cada postura. Inhala 4 seg, exhala 6 seg. La exhalación larga activa el sistema parasimpático (calma).</p>
`},
...
<p><strong>Lútea:</strong> Serotonina baja = antojos de carbos. Dales la versión nutritiva: boniato, arroz integral, avena, plátano (triptófano → serotonina). Magnesio extra. Reduce: exceso de sal, cafeína (amplifica ansiedad), alcohol.</p>
`},
...
<p><strong>Omega-3 (1000mg EPA+DHA):</strong> Antiinflamatorio natural. Reduce cólicos, mejora humor, piel y articulaciones. Aceite de pescado o algas (vegano).</p>
<p><strong>Zinc (15-30mg):</strong> Piel, inmunidad, hormonas, cicatrización. Picolinate es la mejor forma. No tomar con hierro (compiten).</p>
<p><strong>Probióticos:</strong> Gut health = hormonas equilibradas. El estroboloma (bacterias intestinales) metaboliza estrógenos. Variedad de cepas > dosis alta de una sola.</p>
`},
...
<p><strong>Dulce:</strong> Necesitas energía rápida. Alternativa: fruta con mantequilla de maní, dátiles con tahini, yogur con miel.</p>
<h2>La regla</h2>
<p>No luches contra los antojos — redirigelos a opciones nutritivas. Privarte completamente empeora el ciclo de restricción-atracón. Come con consciencia, no con culpa.</p>
`},
'mental-1':{t:'Ansiedad premenstrual: por qué pasa y qué hacer',b:`
...
<p><strong>4. Caminar 30 min:</strong> Aumenta serotonina natural un 40%. No necesitas correr — caminar es suficiente. Idealmente en naturaleza.</p>
<p><strong>5. Journaling 10 min:</strong> Escribe lo que sientes sin filtro. Externalizar los pensamientos rumiativos reduce su poder.</p>
<p><strong>6. Contacto físico:</strong> Abrazo de 20+ seg libera oxitocina que contrarresta directamente el cortisol. Pide un abrazo largo.</p>
<h2>Cuándo buscar ayuda profesional</h2>
<p>Si la ansiedad interfiere con trabajo o relaciones CADA mes, podría ser PMDD. Una ginecóloga puede evaluar opciones (SSRIs cíclicos, terapia cognitivo-conductual).</p>
`},
...
<p><strong>Menstrual:</strong> Introspección. Puede sentirse como tristeza o melancolía. Es momento de reflexionar, no de juzgarte.</p>
<h2>El poder de saberlo</h2>
<p>Cuando sabes que es cíclico, dejas de creerle a la voz autocrítica de la fase lútea. "Esto es la progesterona hablando" es un mantra poderoso.</p>
<p><strong>Regla práctica:</strong> No tomes decisiones grandes (dejar trabajo, terminar relación, cambios drásticos) en fase lútea. Espera a folicular y reevalúa. Si sigues sintiéndolo → es real. Si no → era hormonal.</p>
`},
'mental-3':{t:'Journaling para parejas: cómo empezar',b:`
...
<ul><li>"Hoy agradezco de ti..."</li><li>"Algo que necesito esta semana es..."</li><li>"Un momento que me hizo feliz con nosotros fue..."</li><li>"Algo que me cuesta decir en voz alta..."</li></ul>
<p><strong>4. Compartir (opcional):</strong> Lean en voz alta si se sienten cómodos. Si no, guárdenlo para ustedes.</p>
<p><strong>5. Regla sagrada:</strong> Lo que se escribe NO se usa como arma después. Jamás. Es un espacio seguro o no funciona.</p>
<h2>Por qué funciona</h2>
<p>Reduce malentendidos, crea espacio para vulnerabilidad sin la presión del contacto visual, y documenta el crecimiento de la relación. En 3 meses pueden releer y ver cuánto han avanzado.</p>
`},
'mens-1':{t:'Testosterona: optimización natural sin suplementos mágicos',b:`
...
<p><strong>4. Zinc:</strong> Esencial para síntesis de testosterona. Ostras (el mejor), carne roja, semillas calabaza. 15-30mg/día si suplementas.</p>
<p><strong>5. Reducir alcohol:</strong> +2 copas/día reduce T significativamente. El alcohol aumenta aromatasa (convierte T en estrógeno).</p>
<p><strong>6. Grasa saludable:</strong> Hormonas se fabrican de colesterol. Aguacate, aceite de oliva, nueces, huevos enteros. Dietas muy bajas en grasa = T baja.</p>
<p><strong>7. Manejar estrés:</strong> Cortisol crónicamente alto = T crónicamente baja. Tienen relación inversa. Meditación, naturaleza, deporte.</p>
<h2>Lo que NO funciona</h2>
<p>La mayoría de "testosterone boosters" en suplementos no tienen evidencia. Tribulus, maca, D-ácido aspártico — marketing sin ciencia sólida. Ashwagandha tiene algo de evidencia pero modesta.</p>
`},
'mens-2':{t:'Inteligencia emocional masculina: la habilidad que todo cambia',b:`
...
<p><strong>4. Comunicación:</strong> "Me siento frustrado cuando llegas tarde sin avisar" vs "¡Tú siempre llegas tarde!". Habla de TI, no ataques a ELLA.</p>
<p><strong>5. Vulnerabilidad:</strong> Admitir "no sé qué hacer", "esto me duele", "tengo miedo" es FORTALEZA real. Requiere más valor que pretender que nada te afecta.</p>
<h2>Práctica diaria de 5 minutos</h2>
<p>Pregúntale cómo fue su día. ESCUCHA sin mirar celular durante 5 minutos completos. Sin dar soluciones, sin comparar con tu día, sin interrumpir. Solo presencia. Hazlo 30 días seguidos y la relación se transforma.</p>
`},
'mens-3':{t:'Entender su ciclo: la guía definitiva para él',b:`
...
<p><strong>Lútea (días 17-28):</strong> Irritabilidad, antojos, sensibilidad emocional. TU ROL: NO LO TOMES PERSONAL. Dale espacio + cariño sin presión. No intentes "arreglar" cómo se siente. No digas "¿estás en tus días?" (nunca). Solo acompaña.</p>
<h2>La regla de oro</h2>
<p>Primero empatía. Después soluciones. SIEMPRE en ese orden. "Entiendo que te sientas así" antes de "¿y si probamos...?". Esto solo ya te pone en el top 5% de parejas.</p>
`}};
